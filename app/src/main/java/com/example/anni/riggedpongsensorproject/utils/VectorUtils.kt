...
object VectorUtils {
     ...
     * otherwise.
     */
    fun adjustByRangeX(vector: Vector2, min: Float, max: Float): Boolean {
        if (vector.x < min) {
            vector.x = min
            return true
     ...
     * otherwise.
     */
    fun adjustByRangeY(vector: Vector2, min: Float, max: Float): Boolean {
        if (vector.y < min) {
            vector.y = min
            return true
     ...
     * `false` otherwise.
     */
    fun adjustByRange(vector: Vector2, xMin: Float, xMax: Float,
     ...
     * `false` otherwise.
     */
    fun adjustByRange(vector: Vector2, min: Float, max: Float): Boolean {
     ...
     */
    fun adjustDeadzone(vector: Vector2, radius: Float, adjustedValue: Float): Boolean {
